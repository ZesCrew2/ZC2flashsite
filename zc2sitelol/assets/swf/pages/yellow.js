  ...
  (lib.yellow = function (mode, startPosition, loop, reversed) {
    ...
    this.frame_0 = function () {
      ...
      Microsite.ui.createGalleryPage({
        root: root,
        assetPath: "assets/img/yellow/art/",
        imagePrefix: "art_",
        defaultRatio: "square",
        leftButtonSrc: "assets/img/yellow/left.png",
        rightButtonSrc: "assets/img/yellow/right.png",
        cardShadowColor: "rgba(60,40,0,0.35)",
        cardTextColor: "#774900",
        configUrl: "assets/img/yellow/art-config.json",
