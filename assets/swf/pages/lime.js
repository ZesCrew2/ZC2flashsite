...
lib.ssMetadata = [
		{name:"lime_atlas_1", frames: [[541,0,158,72],[0,0,539,139],[701,0,70,70]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["lime_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.titletext, new cjs.Rectangle(-67.8,-17.9,79,36), null);
...
}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(-8.7,-21.3,38.5,55), null);
...
// stage content:
(lib.lime = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape_1.graphics.f("#C6FF33").s().p("EgnmAeoMAAAg9PMBPNAAAMAAAA9Pg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/lime_atlas_1.png?1778585718537", id:"lime_atlas_1"}
	],
	preloads: []
};
