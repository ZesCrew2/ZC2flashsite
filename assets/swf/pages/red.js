...
lib.ssMetadata = [
		{name:"red_atlas_1", frames: [[456,141,275,72],[733,141,70,70],[456,0,539,139],[0,0,454,262]]}
];
...
}).prototype = getMCSymbolPrototype(lib.titletext, new cjs.Rectangle(-67.8,-17.9,137.5,36), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(13.47,12.8767);
...
p.nominalBounds = new cjs.Rectangle(0,0,27,25.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(8.1,6.15,2.1111,2.1111,0,0,0,13.5,12.8);
	var instanceFilter_1 = new cjs.ColorFilter(0,0,0,1,255,231,187,0);
	this.instance.filters = [instanceFilter_1];
	this.instance.cache(-2,-2,31,30);
...
}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(-20.4,-20.8,56.9,54.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.instance_2 = new lib.texty();
	this.instance_2.setTransform(20,88);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Layer_7
	this.instance_3 = new lib.ssss();
	this.instance_3.setTransform(-27,-33);
	...
	var instance_4Filter_1 = new cjs.ColorFilter(0,0,0,1,221,69,13,0);
	...
	this.shape_1.graphics.f("#FFE7BB").s().p("EgnmAeoMAAAg9PMBPNAAAMAAAA9Pg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/red_atlas_1.png?1778584524998", id:"red_atlas_1"}
	],
	preloads: []
};
