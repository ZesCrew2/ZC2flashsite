...
lib.ssMetadata = [
		{name:"cyan_atlas_1", frames: [[541,0,148,72],[0,0,539,139],[691,0,70,70]]}
];
...
(lib.CachedBmp_8 = function() {
	this.initialize(ss["cyan_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.titletext, new cjs.Rectangle(-67.8,-17.9,74,36), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F8FFFF").s().p("");
	this.shape.setTransform(5.5015,7.0663);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(-29,-20.3,69,54.8), null);
...
// stage content:
(lib.cyan = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(-27,-33);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Layer_5_copy_2
	this.instance_3 = new lib.pp();
	this.instance_3.setTransform(243.5,186.05);
	this.instance_3.compositeOperation = "overlay";

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Layer_5_copy_2
	this.instance_4 = new lib.roate();
	this.instance_4.setTransform(114.35,322.1,1.3383,1.3383,0,0,0,-173,122.5);
	this.instance_4.alpha = 0.4688;
	this.instance_4.compositeOperation = "multiply";
	var instance_4Filter_1 = new cjs.ColorFilter(0,0,0,1,101,202,253,0);
	this.instance_4.filters = [instance_4Filter_1];
	this.instance_4.cache(-507,-212,671,671);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));
	this.timeline.addTween(cjs.Tween.get(instance_4Filter_1).wait(1));

	// Layer_9
	this.instance_5 = new lib.pp();
	this.instance_5.setTransform(243.5,186.05);
	this.instance_5.alpha = 0.7891;
	var instance_5Filter_2 = new cjs.ColorFilter(0,0,0,1,101,202,253,0);
	this.instance_5.filters = [instance_5Filter_2];
	this.instance_5.cache(-245,-188,491,376);
	...
	this.shape_1.graphics.f("#66CCFF").s().p("EgnmAeoMAAAg9PMBPNAAAMAAAA9Pg");
	this.shape_1.setTransform(243.5,186);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_4, startFrame:0, endFrame:1, x:-507, y:-212, w:671, h:671});
	this._renderFirstFrame();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/cyan_atlas_1.png?1778585840994", id:"cyan_atlas_1"}
	],
	preloads: []
};
