...
lib.ssMetadata = [
		{name:"green_atlas_1", frames: [[0,141,248,72],[0,0,539,139],[250,141,70,70]]}
];
...
}).prototype = getMCSymbolPrototype(lib.titletext, new cjs.Rectangle(-67.8,-17.9,124,36), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(15.5125,13.8018);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(5.65,6.65,2.087,2.087,0,0,0,15.5,13.8);
	var instanceFilter_1 = new cjs.ColorFilter(0,0,0,1,243,255,143,0);
	this.instance.filters = [instanceFilter_1];
	this.instance.cache(-2,-2,35,32);
...
}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(-26.6,-22.1,64.6,57.6), null);
...
if (reversed == null) { reversed = false; }
	...
	var instance_4Filter_1 = new cjs.ColorFilter(0,0,0,1,126,185,0,0);
	...
	this.instance_5.alpha = 0.5586;
	this.instance_5.compositeOperation = "multiply";
	var instance_5Filter_2 = new cjs.ColorFilter(0,0,0,1,189,120,0,0);
	...
	this.shape_1.graphics.f("#8FFF2F").s().p("EglfAdEMAAAg6HMBK/AAAMAAAA6Hg");
