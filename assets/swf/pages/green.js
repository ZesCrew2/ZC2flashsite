(function (cjs, an) {
  ...
  (lib.titletext = function (mode, startPosition, loop, reversed) {
    ...
    lib.titletext,
    new cjs.Rectangle(-67.8, -17.9, 124, 36),
    null,
  );
  ...
  (lib.Symbol53 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.icon = function (mode, startPosition, loop, reversed) {
    ...
    lib.icon,
    new cjs.Rectangle(-26.6, -22.1, 64.6, 57.6),
    null,
  );
  ...
  (lib.green = function (mode, startPosition, loop, reversed) {
    ...
    this.frame_0 = function () {
      this.stop();
      if (this._downloadsReady) return;
