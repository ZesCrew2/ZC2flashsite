...
lib.ssMetadata = [
		{name:"orange_atlas_1", frames: [[456,0,134,72],[0,259,539,139],[456,74,70,70],[0,0,454,257]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["orange_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.titletext, new cjs.Rectangle(-67.8,-17.9,67,36), null);
...
(lib.BOWcopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFAA").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.BOWcopy, new cjs.Rectangle(-63.7,-42,127.4,84), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_5
	this.instance = new lib.BOWcopy();
	this.instance.setTransform(6.95,10.35,0.573,0.573);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.icon, new cjs.Rectangle(-29.5,-13.7,73,48.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(19,82,0.9446,0.9446);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_3
	this.instance_1 = new lib.icon();
	this.instance_1.setTransform(38,30.45,0.9446,0.9446);
	...
	this.instance_2.setTransform(170.25,30,0.9446,0.9446);
	...
	this.instance_3.setTransform(-26,-31,0.9446,0.9446);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Layer_5_copy_2
	this.instance_4 = new lib.pp();
	this.instance_4.setTransform(230,175.7,0.9446,0.9446);
	...
	this.instance_5.setTransform(108,304.2,1.2642,1.2642,0,0,0,-173,122.5);
	this.instance_5.alpha = 0.5;
	this.instance_5.compositeOperation = "overlay";
	var instance_5Filter_1 = new cjs.ColorFilter(0,0,0,1,176,255,255,0);
	this.instance_5.filters = [instance_5Filter_1];
	this.instance_5.cache(-507,-212,671,671);
	...
	// stageBackground
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("EglfgdAMBK/AAAMAAAA6BMhK/AAAg");
	this.shape.setTransform(230,175.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFB32A").s().p("EglfAdBMAAAg6BMBK/AAAMAAAA6Bg");
	this.shape_1.setTransform(230,175.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_5, startFrame:0, endFrame:1, x:-507, y:-212, w:671, h:671});
	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(50.3,144.5,432.9,445.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/orange_atlas_1.png?1778852983928", id:"orange_atlas_1"}
	],
	preloads: []
};
