...
export const CEIL_Y = 1.01;
export const BUTTON_SIZE = 0.3;
...
export const TEXT_CHAR_JITTER_MS = 50;
export const HUD_MESSAGE_HOLD_MS = 5000;
export const HUD_CYCLE_MIN_DELAY_MS = 5000;
export const HUD_CYCLE_JITTER_MS = 10000;
export const MUSIC_FADE_DURATION_MS = 5000;
export const MUSIC_FADE_INTERVAL_MS = 100;
export const MUSIC_FADE_TARGET_VOLUME = 0.7;
export const END_RELOAD_DELAY_MS = 1500;
export const HUD_OFFSET_PX = 30;
export const HUD_MAX_WIDTH_PAD_PX = 60;
...
export const ASSET_WALL_ROUGH = 'wall_rough';
export const ASSET_FLOOR_DIFF = 'floor_diff';
export const ASSET_FLOOR_NOR = 'floor_nor';
export const ASSET_FLOOR_ROUGH = 'floor_rough';
export const ASSET_BTN_CLOSED = 'btn_closed';
export const ASSET_BTN_OPENED = 'btn_opened';
export const ASSET_SKYBOX = 'skybox';
export const ASSET_WALL_MOVE = 'wall_move';
...
export const SOUND_MAZE_END_SFX = 'maze_end_sfx';
export const SOUND_MAZE_MUSIC = 'maze_music';
